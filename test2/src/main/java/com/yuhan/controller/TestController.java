...
public class TestController {
	...
	public String change(Model model, Product products) {
		return "/protected/change";
	}
	@GetMapping("/protected/faq")
	public String qa(Model model, Product products) {
		return "/protected/faq";
	}
	@GetMapping("/header.html")
	public String main(Model model, Product products) {
		return "/main.html";
	}
